# -*- coding: utf-8 -*-
"""
Created on Thu Dec  1 19:12:49 2016

@author: Will
"""

#SNNCliq.py Will Hackett 12.1.16
...
def usage():
	help_msg="\n  usage: SNNCliq.py -e <input_matrix> -i <edge_file> -o <out_file> [options]\n\
    -e --e input_matrix has sample rows and gene columns \n\
    -i --i is output file of SNN for use with cliq.py \n\
...
def main(argv):
    ...
    try:
        opts, args=getopt.getopt(argv, "e:i:o:k:r:m:n:h", ["input=","output=","merging=","r-quasi-cliq=","number=","help"])
